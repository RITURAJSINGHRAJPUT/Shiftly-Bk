...
const ACTION_COLORS = {
  ...
  EMPLOYEE_REACTIVATE: 'good',
  EMPLOYEE_CODE_RELEASED: 'warn',
  EMPLOYEE_DEACTIVATE: 'crit',
  STAFF_WIPE: 'crit',
  SHIFT_CREATE: 'good',
  SHIFT_EDIT: 'info',
...
const ACTION_OPTIONS = [
  ...
  'EMPLOYEE_CREATE', 'EMPLOYEE_EDIT', 'EMPLOYEE_DELETE', 'EMPLOYEE_REACTIVATE', 'EMPLOYEE_CODE_RELEASED', 'EMPLOYEE_DEACTIVATE', 'STAFF_WIPE',
  'SHIFT_CREATE', 'SHIFT_EDIT', 'SHIFT_ALLOCATE', 'SHIFT_DELETE', 'SHIFT_RESET',
  'LEAVE_APPROVE', 'LEAVE_REJECT', 'LEAVE_CREATE', 'LEAVE_EDIT', 'LEAVE_CANCEL',
